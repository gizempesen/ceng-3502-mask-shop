    ...
    <div class="col">
        ...
        <div class="card reg_style">
            ...
            <div class="card-header card-header-color text_color" align="center">
                <H4 >YOUR PROFILE</H4
                <p class="mb-0"> You can change inputs to update your profile.</p>
            </div>
            ...
            <div class="card-body card-body-color text_body" >
                <form  method = "post">
                    <div class="form-group" >
                        ...
                        <input class="form-control" type="text"  name="txt_name" value= <?php echo $name1 ?>>
                    </div>

                    <div class="form-group">
                        <label for="surname">Surname</label>
                        <input class="form-control" type="text"  name="txt_lastname" value="<?php echo $lastname1 ?>">
                    </div>

                    <div class="form-group">
                        <label for="exampleInputEmail1">Email Address</label>
                        <input type="email" class="form-control"name = 'txt_email' aria-describedby="emailHelp" value="<?php echo $email1 ?>">
                    </div>
                    ...
                    <div align="center">
                        <input type="submit"  name="btn_edit" class="btn btn-success " value="Edit Your Profile" >
                    </div>
